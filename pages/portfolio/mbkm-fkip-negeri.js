  ...
  return (
    <div>
      ...
      <Template menu='/portfolio'>
        <h2 className='text-orange-500 font-bold text-xl mb-5 mt-5'>Information System For MBKM FKIP NEGERI Indonesia</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-x mt-5 mb-10">
          <div className='p-3 px-5'>
            ...
            <a className='text-orange-500 underline' href="https://mbkmfkipnegeri.id/">
              Click here
            </a>
          </div>
          <div className='p-3 px-5'>
