  ...
  return (
    <div>
      ...
      <Template menu='/portfolio'>
        <h2 className='text-orange-500 font-bold text-xl mb-5 mt-5'>STEM INDONESIA</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 divide-x mt-5 mb-10">
          <div className='p-3 px-5'>
            ...
            <a className='text-orange-500 underline' href="https://play.google.com/store/apps/details?id=com.androxxe.STEM">
              Click here
            </a>
          </div>
          <div className='p-3 px-5'>
